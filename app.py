...
CSV_URL = "https://raw.githubusercontent.com/cybermainframe/dividend-aristocrats-dashboard/refs/heads/main/data/dividend_aristocrats_latest.csv"
...
st.title("👑 Dashboard Dividend Aristocrats")
st.caption("Ações do S&P 500 com 25+ anos de aumento de dividendos, ordenadas pela distância face à mínima de 52 semanas.")
